...
#define TOUCH_RST_PIN LL_GPIO_PIN_8
#define TOUCH_INT_PIN LL_GPIO_PIN_9
#define TOUCH_RST_PORT GPIOB
#define TOUCH_INT_PORT GPIOB

/* functions define */
#define TOUCH_RST_0 LL_GPIO_ResetOutputPin(TOUCH_RST_PORT, TOUCH_RST_PIN)
#define TOUCH_RST_1 LL_GPIO_SetOutputPin(TOUCH_RST_PORT, TOUCH_RST_PIN)
