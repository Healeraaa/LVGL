...
/**
  ...
  *         of uint16_t provided through pTxData.
  * @param  husart  Pointer to a USART_HandleTypeDef structure that contains
  *                 the configuration information for the specified USART module.
  * @param  pTxData Pointer to data buffer (uint8_t or uint16_t data elements).
  * @param  Size    Amount of data elements (uint8_t or uint16_t) to be sent.
...
/**
  ...
  *         of uint16_t available through pRxData.
  * @param  husart  Pointer to a USART_HandleTypeDef structure that contains
  *                 the configuration information for the specified USART module.
  * @param  pRxData Pointer to data buffer (uint8_t or uint16_t data elements).
...
/**
  ...
  * @note   When USART parity is not enabled (PCE = 0), and Word Length is configured to 9 bits (M1-M0 = 01),
  *         the sent data and the received data are handled as sets of uint16_t. In this case, Size must indicate the number
  *         of uint16_t available through pTxData and through pRxData.
  * @param  husart  Pointer to a USART_HandleTypeDef structure that contains
  *                 the configuration information for the specified USART module.
  * @param  pTxData Pointer to TX data buffer (uint8_t or uint16_t data elements).
  * @param  pRxData Pointer to RX data buffer (uint8_t or uint16_t data elements).
  * @param  Size    Amount of data elements (uint8_t or uint16_t) to be sent (same amount to be received).
  * @param  Timeout Timeout duration
  * @retval HAL status
  */
                                            ...
                                            uint16_t Size, uint32_t Timeout)
{
  ...
  if (husart->State == HAL_USART_STATE_READY)
  {
    ...
    /* In case of 9bits/No Parity transfer, pTxData and pRxData buffers provided as input parameter
       should be aligned on a uint16_t frontier, as data to be filled into TDR/retrieved from RDR will be
...
/**
  ...
  * @param  pTxData Pointer to TX data buffer (uint8_t or uint16_t data elements).
  * @param  pRxData Pointer to RX data buffer (uint8_t or uint16_t data elements).
  * @param  Size    Amount of data elements (uint8_t or uint16_t) to be received/sent.
  * @note   When the USART parity is enabled (PCE = 1) the data received contain the parity bit.
  * @retval HAL status
  */
