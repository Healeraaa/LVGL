...
#define LV_MEM_CUSTOM 1
    ...
    #if LV_MEM_ADR == 0
//        #define LV_MEM_POOL_INCLUDE "./MALLOC/malloc.h"  /* Uncomment if using an external allocator*/
//        #define LV_MEM_POOL_ALLOC   lv_mymalloc          /* Uncomment if using an external allocator*/
    #endif
