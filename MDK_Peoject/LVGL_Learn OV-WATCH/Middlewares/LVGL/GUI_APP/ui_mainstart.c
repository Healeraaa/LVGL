...
static void lv_example_switch1(void)
{
    ...
    lv_obj_set_size(obj_cool,scr_act_height() / 4, scr_act_height() / 3 );          /* 设置大小 */
...
static void lv_example_switch2(void)
{
    ...
    lv_obj_set_size(obj_heat,scr_act_height() / 4, scr_act_height() / 3 );
...
static void lv_example_switch3(void)
{
    ...
    lv_obj_set_size(obj_dry,scr_act_height() / 4, scr_act_height() / 3 );
